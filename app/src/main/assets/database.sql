...
CREATE TABLE sondage (ID_sondage integer PRIMARY KEY NOT NULL, createur text NOT NULL REFERENCES utilisateur (identifiant), resultat text, statut text NOT NULL);
INSERT INTO sondage (ID_sondage, createur, resultat, statut) VALUES (1, 'Quentin', NULL, 'ouvert');
INSERT INTO sondage (ID_sondage, createur, resultat, statut) VALUES (2, 'Sara', '', 'ouvert');
INSERT INTO sondage (ID_sondage, createur, resultat, statut) VALUES (3, 'floflo', '', 'ouvert');
