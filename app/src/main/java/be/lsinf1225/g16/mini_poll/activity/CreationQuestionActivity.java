...
public class CreationQuestionActivity extends AppCompatActivity {
    ...
    private CreationQuestionActivity.MyViewPagerAdapter myViewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                ...
                R.layout.creation_question_send};
        ...
        myViewPagerAdapter = new CreationQuestionActivity.MyViewPagerAdapter();
    ...
    private void launchHomeScreen() {
        startActivity(new Intent(CreationQuestionActivity.this, MenuMainActivity.class));
        finish();
    }
