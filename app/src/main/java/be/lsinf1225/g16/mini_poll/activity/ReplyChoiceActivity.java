...
public class ReplyChoiceActivity  extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.s = (AiderUnAmi) MiniPollApp.connectedUser.getSondage(sondageID);
        ...
        mPagerAdapter = new ReplyChoiceActivity.ScreenSlidePagerAdapter(getSupportFragmentManager());
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if(getCount()==1){
                ...
                switch (position) {
                    case 0:
                        return new ReplyChoiceFillAnswer();
                    case 1:
                        return new ReplyChoiceSummary();
                    default:
