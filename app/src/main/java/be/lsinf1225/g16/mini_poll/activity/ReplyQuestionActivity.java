...
import be.lsinf1225.g16.mini_poll.activity.replyFragment.ReplyQuestionFillAnswer;
import be.lsinf1225.g16.mini_poll.activity.replyFragment.ReplyQuestionSummary;
import be.lsinf1225.g16.mini_poll.model.Participant;
import be.lsinf1225.g16.mini_poll.model.Questionnaire;
...
public class ReplyQuestionActivity  extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.s = (Questionnaire) MiniPollApp.connectedUser.getSondage(sondageID);
        ...
        mPagerAdapter = new ReplyQuestionActivity.ScreenSlidePagerAdapter(getSupportFragmentManager());
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if(getCount()==1){
                return new ReplyQuestionSummary();
            }else {

                switch (position) {
                    case 0:
                        return new ReplyQuestionFillAnswer();
                    case 1:
                        return new ReplyQuestionSummary();
                    default:
