...
public class ReplyQuestionActivity extends AppCompatActivity {
    ...
    private ReplyQuestionActivity.MyViewPagerAdapter myViewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layouts = new int[]{
                R.layout.reply_question_fill_answer,
        ...
        myViewPagerAdapter = new ReplyQuestionActivity.MyViewPagerAdapter();
    ...
    private void launchHomeScreen() {
        startActivity(new Intent(ReplyQuestionActivity.this, MenuMainActivity.class));
        finish();
    }
